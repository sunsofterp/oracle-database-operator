...
func (d *DatabaseService) CreateAutonomousDatabase(ctx context.Context, adb *dbv4.AutonomousDatabase) (resp database.CreateAutonomousDatabaseResponse, err error) {
	...
	createAutonomousDatabaseDetails := database.CreateAutonomousDatabaseDetails{
		...
		DatabaseEdition:               database.AutonomousDatabaseSummaryDatabaseEditionEnum(adb.Spec.Details.DatabaseEdition),
...
func (d *DatabaseService) CreateAutonomousDatabaseClone(ctx context.Context, adb *dbv4.AutonomousDatabase) (resp database.CreateAutonomousDatabaseResponse, err error) {
	...
	request := database.CreateAutonomousDatabaseRequest{
		CreateAutonomousDatabaseDetails: database.CreateAutonomousDatabaseCloneDetails{
			...
			DatabaseEdition:               database.AutonomousDatabaseSummaryDatabaseEditionEnum(adb.Spec.Clone.DatabaseEdition),
